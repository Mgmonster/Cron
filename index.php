...
<div class="container">
    ...
    <div id="new">
        ...
        <form>
            ...
            <div class="alert alert-success">
                <strong>在线帮助：</strong> <a href="http://zh.wikipedia.org/wiki/Cron" target="_blank">http://zh.wikipedia.org/wiki/Cron</a>
            </div>
    ...
    <div class="footer">
        <p>&copy; <?php echo date('Y'); ?> <a href="http://www.lapland.name" target="_blank">拉普兰德</a></p>
    </div>
</div>
